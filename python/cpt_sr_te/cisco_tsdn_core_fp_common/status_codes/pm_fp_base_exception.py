...
from .pm_status_codes import StatusCodes
    ...
    def __init__(self, log, code, exp_msg=None, child_obj=None):
        if child_obj:
            super(CfpCommonException, self).__init__(
                log, child_obj, StatusCodes.getNativeId(code), "TSDN-PM", "PM", exp_msg
            )
        else:
            super(CfpCommonException, self).__init__(
                log, self, StatusCodes.getNativeId(code), "TSDN-PM", "PM", exp_msg
            )
